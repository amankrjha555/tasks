...
|`T3`|  Adding Column | Comparing output generated by our testscript   | Different in output value because of column inserted| Different output |`PASS`|
|`T4` | Adding Row  |  Comparing output after adding a row | Different in output because of column inserted | Different output  |`PASS` |
  </details>
